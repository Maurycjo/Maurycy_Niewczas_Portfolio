 ...
 * W przypadku niepowodzenia wykonania jakieś metody wyrzucony zostanie wyjątek.
 * 
 * @author tkubik
 *
 */
public interface ClusterAnalysisService {
	...
	// wyrzuca wyjątek, jeżli aktualnie trwa przetwarzanie danych
	public void submit(DataSet ds) throws ClusteringException;

	// metoda pozwalająca pobrać wynik analizy
    // zwraca null - jeżli trwa jeszcze przetwarzanie lub nie przekazano danych do analizy
	// wyrzuca wyjątek - jeżli podczas przetwarzania doszło do jakichś błędów
	// clear = true - jeżli wyniki po pobraniu mają zniknąć z serwisu
